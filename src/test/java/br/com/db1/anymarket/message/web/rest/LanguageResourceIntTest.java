...
public class LanguageResourceIntTest {
    ...
    private static final String DEFAULT_I_18_N_CODE = "AAAAAAAAAA";
    private static final String UPDATED_I_18_N_CODE = "BBBBBBBBBB";
    ...
    public void createLanguage() throws Exception {
        ...
        assertThat(testLanguage.geti18nCode()).isEqualTo(DEFAULT_I_18_N_CODE);
    }
    ...
    @Test
    @Transactional
    public void checki18nCodeIsRequired() throws Exception {
        int databaseSizeBeforeTest = languageRepository.findAll().size();
        // set the field null
        language.seti18nCode(null);
    ...
    public void getAllLanguages() throws Exception {
        ...
        restLanguageMockMvc.perform(get("/api/languages?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].i18nCode").value(hasItem(DEFAULT_I_18_N_CODE.toString())));
    }
    ...
    public void getLanguage() throws Exception {
        ...
        restLanguageMockMvc.perform(get("/api/languages/{id}", language.getId()))
            ...
            .andExpect(jsonPath("$.i18nCode").value(DEFAULT_I_18_N_CODE.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateLanguage() throws Exception {
        ...
        assertThat(testLanguage.geti18nCode()).isEqualTo(UPDATED_I_18_N_CODE);
    }
